...
<main>
  <section>
    ...
    <a href="{data.person.github_handle}" target="_blank" class:hide={current != 3} class:show={current === 3}>
    ...
    <img src="{data.person.avatar}" alt="baby groot" width="90px" height="90px" class:hide={current != 4} class:show={current === 4}>
