...
<main>
  <section>
    <p class="placeholder">Strum om meer over mij uit te vinden.</p>
    <p class="fullname">{data.person.name} {data.person.surname}</p>
    <p class="nickname">{data.person.nickname}</p>
    <div class="github">
